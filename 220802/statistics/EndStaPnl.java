// 엔딩시 통계 꺼낼 때...
// EndStaPnl endPnl = new EndStaPnl();
// endPnl.setEndingNum("엔딩 테이블에서 id 번호...");
// new AchvPnl(loguser).setVisible(true);
// endPnl.setEndingNum(0);
// 통계 끝나고 다음 회차 넘어갈 때
// Statistics st = new Statistics();
// st.EndingJustment("엔딩 id 번호", endPnl.getEndcount);
...
public class EndStaPnl extends JFrame {
	...
	public EndStaPnl(BusanUser busanUser) {
		...
		if(endingNum > 0) { // 엔딩 봤을 때 통계 내보내기
			...
			graphicFont5 = "이 엔딩은 " + Endcount + "명의 사람들이 봤습니다.";
