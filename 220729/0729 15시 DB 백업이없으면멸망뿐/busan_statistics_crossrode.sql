...
CREATE TABLE `statistics_crossrode` (
  `num` int NOT NULL,
  `storyPath1` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `storyPath2` varchar(45) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `statistics_crossrode` VALUES (1,'7','1','고모리',2),(2,'2/5/7','1/3/6/7','',0);
