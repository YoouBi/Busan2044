...
CREATE TABLE `inventory_table` (
  ...
  `inventory_durability` int NOT NULL,
  KEY `fk_inventory_idx` (`item_id`),
  CONSTRAINT `fk_inventory` FOREIGN KEY (`item_id`) REFERENCES `item_table` (`item_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `inventory_table` VALUES (1,1,3),(2,1,1),(3,1,999);
