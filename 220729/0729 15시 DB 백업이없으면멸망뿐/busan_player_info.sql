...
CREATE TABLE `player_info` (
  ...
  `yourAttainment` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `yourEndings` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `yourVictory` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `yourAchv` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `player_info` VALUES ('magic22x',NULL,'1/2',NULL,'01/02');
